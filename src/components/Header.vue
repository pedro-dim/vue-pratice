  ...
  <div class="2xl:container 2xl:mx-auto">
    ...
    <div class="bg-white rounded shadow-lg py-5 px-7">
      <nav class="flex justify-between">
        ...
        <ul v-for="(link, index) in links" :key="index" class="hidden md:flex flex-auto space-x-2">
          <li @click="selected()" class=" focus:outline-none
            focus:ring-2
            focus:ring-offset-2 focus:ring-gray-800 text-white bg-indigo-600
        ...
        <div class="flex space-x-5 justify-center items-center pl-2">
          ...
          <svg class="cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800" width="24"
      ...
      <div class="block md:hidden w-full mt-5">
        ...
        <div class="relative">
          <ul id="list" class="hidden font-normal text-base leading-4 absolute top-2 w-full rounded shadow-md">
            <li @click="selectedSmall()" v-for="(link, index) in links" :key="index"
